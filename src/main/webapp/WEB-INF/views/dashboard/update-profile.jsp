...
<div class="container mt-5 pt-5" style="min-height: 70vh;">
	<form:form modelAttribute="profile" action="update-profile"
		...
		<div class="row border rounded-3 p-3 mb-4"
			...
			<div
				class="col-3 border-none rounded-circle align-self-stretch text-center fs-1 d-flex align-items-center justify-content-center  bg-dark bg-gradient text-white">
			...
			<div class="col-7">
				...
				<div class="form-floating mb-2">
					<input type="text" class="form-control" value="${title}"
						name="title" placeholder="Your title"> <label for="title">Title</label>
				</div>
					...
					<div class="row">
						<div class="col-6 form-floating mb-2">
							<input type="text" class="form-control" value="${city}"
								name="city" placeholder="Your city"> <label for="city"
								class="ms-3">City</label>
						</div>
						<div class="col-6 form-floating mb-2">
							<input type="text" class="form-control" value="${country}"
								name="country" placeholder="Your country"> <label
								for="country" class="ms-3">Country</label>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-9">
				...
				<div class="mb-3 rounded p-2"
					...
					<div class="d-flex">
						...
						<button type="button" class="btn btn-primary ms-auto"
							data-bs-toggle="modal" data-bs-target="#experiences">
					...
					<c:forEach var="e" items="${ex}">
						...
						<div
							...
							<div class="interactive-bc">
								<button type="button"
									class="btn btn-outline-primary button-card-hover"
									data-bs-toggle="modal" data-bs-target="#ex<%=i%>">Edit</button>
								<button type="button"
									class="btn btn-outline-danger button-card-hover">Delete</button>
							</div>
						</div>
				...
				<div class="mb-3 rounded p-2"
					...
					<div class="d-flex">
						<h3>Education</h3>
						<button type="button" class="btn btn-primary ms-auto"
							data-bs-toggle="modal" data-bs-target="#educations">Add
							Education</button>
					...
					<c:forEach var="e" items="${ed}">
						<div class="d-flex align-items-center">
							...
							<div class="interactive-bc">
								<button type="button"
									class="btn btn-outline-primary button-card-hover"
									data-bs-toggle="modal" data-bs-target="#ed<%=i%>">Edit</button>
								<button type="button"
									class="btn btn-outline-danger button-card-hover">Delete</button>
							</div>
						</div>
			...
			<div class="col-3">
				<div>
					<div class="d-flex align-items-center mb-3">
						<div class="form-floating ml-3 rounded"
							style="background-color: rgba(255, 255, 255, 0.5); border: 1px solid grey; box-shadow: 1px 1px 1px 1px rgba(0, 0, 0, 0.6);">
