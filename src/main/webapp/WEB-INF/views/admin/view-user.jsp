...
<jsp:include page="../../header.jsp">
	<jsp:param value="View Profile" name="HTMLtitle" />
</jsp:include>
...
<div class="container mt-5 pt-5" style="min-height: 70vh;">
	<div class="row border rounded-3 p-2 mb-4"
		...
		<div
			class="col-2 border-none rounded-circle align-self-stretch text-center fs-1 d-flex align-items-center justify-content-center bg-info bg-gradient text-white">
		...
		<div class="col-2 align-self-center">
				<form action="edit-profile" method="get" class="ms-auto">
		...
		<div class="col-6">
			<div class="row rounded  mx-auto mb-3 pb-2"
				...
				<div class="col-12">
					<div class="row p-2">
						<div
							class="col-2 border-none rounded align-self-stretch text-center fs-1 d-flex align-items-center justify-content-center bg-info bg-gradient text-white">
							<span>${f}</span> <span>${l}</span>
						</div>
						<div class="col-10">
							<div class="mt-3">
